...
## [1.87.0](https://github.com/p-sternik/smart-indexer/compare/v1.86.0...v1.87.0) (2025-12-29)


### Features

* Add `SqlWorker` entry point and refactor esbuild configuration to use object-based entry points. ([0ea0089](https://github.com/p-sternik/smart-indexer/commit/0ea00896ae6f394b1002c398fa2235dac5b9d623))
...
* add SqlJsStorage for SQLite-based index storage with schema migrations, FTS5, and crash recovery. ([7ee9b52](https://github.com/p-sternik/smart-indexer/commit/7ee9b524c1e1ee2e6ffba4abd269d7c9d379b875))

## [1.84.0](https://github.com/p-sternik/smart-indexer/compare/v1.83.0...v1.84.0) (2025-12-29)


### Features

* Implement a background sharded index with persistent storage and NgRx link resolution. ([c775cd7](https://github.com/p-sternik/smart-indexer/commit/c775cd773e9882988c936d773503623f502bbab3))
...
* **debug:** Add command to show forensic traces and enhance menu options ([734307a](https://github.com/p-sternik/smart-indexer/commit/734307a65ed6fbe52b64019c042b2bc27c8aa159))

## [1.79.0](https://github.com/p-sternik/smart-indexer/compare/v1.78.0...v1.79.0) (2025-12-09)


### Features

* **logging:** Implement RequestTracer for forensic performance diagnostics ([481dba4](https://github.com/p-sternik/smart-indexer/commit/481dba42bf9d864d641d67b8b5d4b80b9faf8072))
...
* Add NgRx createActionGroup support with camelCase transformation and comprehensive testing ([ea5846e](https://github.com/p-sternik/smart-indexer/commit/ea5846ebe45acda537608d698053f54bc4058555))
...
* Implement LRU caching for definition requests and improve status bar feedback ([eb3408e](https://github.com/p-sternik/smart-indexer/commit/eb3408eb54b2cb322587d5d16e4392917905a6a3))
...
* remove unused sql-wasm.wasm file ([5ec1a16](https://github.com/p-sternik/smart-indexer/commit/5ec1a16694ed0e151de55aa23d9f2c5e33213b70))
...
* enhance timeout handling in definition fetching and disambiguation processes ([e0291b9](https://github.com/p-sternik/smart-indexer/commit/e0291b9e6882a0d2e2c52f8ae4f571a2bf855fbf))

## [1.70.0](https://github.com/p-sternik/smart-indexer/compare/v1.69.0...v1.70.0) (2025-12-08)


### Features

* prioritize code symbols over text symbols in definition filtering and indexing ([9326594](https://github.com/p-sternik/smart-indexer/commit/93265948413125e7da6cbcb2381fffed1e644950))
